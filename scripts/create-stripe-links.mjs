...
import { artUrl, getPacks } from "../api/catalog.js";
...
const site = env.VITE_SITE_URL || "https://rbmsounds.com";
...
async function main() {
  ...
  for (const pack of Object.values(packs)) {
    ...
    const thanks = `${site}/thanks?p=${encodeURIComponent(pack.id)}&t=${encodeURIComponent(pack.token)}`;
    ...
    console.log(pack.name, link.url);
  }
  ...
  console.log("Updated .env with Payment Links");
}
